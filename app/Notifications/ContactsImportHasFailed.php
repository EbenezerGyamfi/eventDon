...
class ContactsImportHasFailed extends Notification
{
    use Queueable;
    ...
    public function toSms($notifiable)
    {
        ...
        $message = "Hello {$notifiable->name}.\nYour contacts failed to be imported into '{$contactGroup->name}'. Kindly check your file and try again later!";
