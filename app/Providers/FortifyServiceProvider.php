...
use App\Http\Responses\RegisterResponse as RegisterResponse;
use App\Models\User;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Fortify::requestPasswordResetLinkView(fn () => view('client.Auth.sendPasswordLink'));
        ...
        Fortify::verifyEmailView(fn () => view('client.Auth.verifyEmail'));
    }
}
