...
use App\DataTables\EventTicketTypesDataTable;
...
class EventTicketTypeController extends Controller
{
    ...
    public function index(Event $event)
    {
        ...
        $datatable = new EventTicketTypesDataTable($event);

        return $datatable->render('client.ticket-types.index', [
            'event' => $event,
        ]);
    }
    ...
    public function update(UpdateTicketTypeRequest $request, Event $event, TicketType $ticketType)
    {
        ...
        return back()->withMessage('Ticket type updated');
    }
