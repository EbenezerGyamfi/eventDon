...
<style>
    ...
    @media(min-width:1038px) and (max-width:1170px) {
        .card-category {
...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="white" data-active-color="danger">
            <div class="logo">
                <a href="{{ route('events.index') }}" class="simple-text logo-normal">
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <x-sidenav-list-item :route="route('events.index')">
                    ...
                    @if (auth()->user()->role == 'client')
                        <x-sidenav-list-item :route="route('contacts.groups.index')">
                        ...
                        <x-sidenav-list-item :route="route('wallet-events.index')">
                        ...
                        <x-sidenav-list-item :route="route('user-management.index')">
                        ...
                        <x-sidenav-list-item :route="route('sms-campaigns.index')">
                    ...
                    @endif
                    <x-sidenav-list-item :route="route('donations.index')">
                        <a href="{{ route('donations.index') }}">
                            <i class="nc-icon nc-diamond"></i>
                            <p>Donations</p>
                        </a>
                    </x-sidenav-list-item>
                    <x-sidenav-list-item :route="route('ticketing.index')">
                    ...
                    <x-sidenav-list-item :route="route('gifts.index')">
                    ...
                    <x-sidenav-list-item :route="route('gifts.index')">
                        <a href="{{ route('guests-list.index') }}">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        ...
                        <ul class="navbar-nav d-flex flex-column justify-content-center align-items-center d-lg-none">
                            ...
                            @if (auth()->user()->role == 'client')
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('contacts.groups.index') }}">
                                        Contact Groups
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('wallet-events.index') }}">
                                        Billing
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('sms-campaigns.index') }}">
                                        SMS Campaign
                                    </a>
                                </li>
                            @endif
