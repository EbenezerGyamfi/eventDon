...
@section('content')
    <form class="form" method="POST" id="passwordReset" action="{{ route('password.update') }}">
        @csrf
        <div class="card card-login">
            ...
            <div class="card-body ">
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="email" id="token" value="{{ $email }}">
                    ...
                    <div class="input-group col-12 ">
                        ...
                        <input type="password" placeholder="Confirm Password" name="password_confirmation"
                            class="form-control password_confirm @error('password') is-invalid @enderror">
                        @error('password')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="card-footer ">
                <button type="submit" class="btn btn-warning btn-round btn-block mb-3" id="btn"> Reset Password
                </button>
...
@push('scripts')
    <script>
        // Send Reset Link
        const requestPasswordResetLink = $('#passwordReset');
        const linkBtn = $('#btn');
        requestPasswordResetLink.on('submit', function() {
            ...
            $.ajax({
                    ...
                    processData: false,
                    dataType: 'json',
                    data: new FormData(requestPasswordResetLink[0])
