...
@section('meta_description', 'Forgot your password? Don\'t worry, you can pick a new one in less than a minute')

@section('content')
    <form class="form" method="POST" action="{{ route('password.email') }}" id="passwordReset">
        @csrf
        <div class="card card-login">
            ...
            <div class="card-footer ">
                <button type="submit" class="btn btn-warning btn-round btn-block mb-3" id="btn">Send Reset
                    Link</button>
