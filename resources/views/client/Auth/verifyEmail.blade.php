...
@section('content')
    <form class="form" action="{{ route('verification.send') }}" id="sendEmailForm" method="POST">
        @csrf
        <div class="card card-login">
            <div class="card-header ">
                ...
                <div class="card-header ">
                    <h3 class="header text-center">Verify Email</h3>
                </div>
            </div>
            <div class="card-body ">
                <small> Verification Link has been sent to</small>
                <h5>{{ auth()->user()->email }}</h5>
            </div>
            <div class="card-footer ">
                <button type="submit" class="btn btn-warning btn-round btn-block mb-3">Resend Verification Email</button>
            </div>
        </div>
    </form>
@endsection
