...
@section('meta_description', 'We\'ve been waiting for you. Unlock your account let\'s get started! There\'s much to do.')
    ...
    <form class="form" action="{{ route('login') }}" method="POST">
        ...
        <div class="card card-login">
            ...
            <div class="card-body ">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control @error('email') is-invalid @enderror" name="email"
                        autocomplete="email" placeholder="Email" for="email">
                    @error('email')
                ...
                <div class="input-group">
                    ...
                    <input type="password" placeholder="password" for="password" name="password"
                        class="form-control @error('password') is-invalid @enderror">
                    @error('password')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                <div class="d-flex remember-me flex-row justify-content-between align-items-center pt-3">
                    <div style="margin-left: 1em;">
                        <input class="form-check-input" type="checkbox" name="remember" checked id="remember">
                        <label class="form-check-label" for="remember">
                            Remember Me </label>
                    </div>
                    <div> <small class="text-nowrap"><a href="{{ route('password.request') }}" class="text-sm">Forgot
                                Password?</a></small>
                    </div>
                </div>
                <br>
            ...
            <div class="card-footer text-center py-4">
                ...
                <a href="{{ route('register') }}" class="mb-3 text-center">Don't have an
                    account
                    yet ? Register!</a>
            </div>
        </div>
