            ...
            <div class="card mt-5">
                <div class="card-header">
                    <div class="card-header d-flex flex-row justify-content-between">
                        <h4 class="card-title"> Pre-Registered Attendees </h4>
                    ...
                    @if ($numberOfPreRegisteredAttendees > $attendeesLimit)
                        <div class="alert alert-info my-2" role="alert">
                            The total number of pre-registered attendees exceeds the limit of your plan. Please
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('events.attendees.send-sms', $event->id) . '?pre_registered=true' }}"
                        method="POST">
                        @csrf
